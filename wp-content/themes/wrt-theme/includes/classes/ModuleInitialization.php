...
class ModuleInitialization {
	...
	/**
	 * Get all the WRTTheme plugin classes.
	 *
	 * @return array
	 */
	protected function get_classes() {
		$class_finder = new ClassFinder();
		$class_finder::setAppRoot( WRT_THEME_PATH );
		return $class_finder::getClassesInNamespace( 'WRTTheme', ClassFinder::RECURSIVE_MODE );
	}

	/**
	 * Initialize all the WRTTheme plugin classes.
	 *
	 * @return void
	 */
	public function init_classes() {
		...
		foreach ( $this->get_classes() as $class ) {
			...
			if ( ! $reflection_class->isSubclassOf( '\WRTTheme\Module' ) ) {
				continue;
			}
